...
<head>
	<meta charset="utf-8">
	<title>左边栏</title>
	<link rel="stylesheet" type="text/css" href="../css/wleft.css">
	...
	<div class="container">
		<dl>
			<dt class="main">
				...
				<span><a href="/OrderSysSSH/waiterDishAction" target="right">点餐服务</a></span>
			</dt>
		</dl>
		<dl>
			<dt class="main">
				<img src="../images/coin17.png" class="icon2">
				<span><a href="/OrderSysSSH/orderPayAction-showorders" target="right">结账服务</a></span>
			</dt>
		</dl>
		<dl>
			<dt class="main">
