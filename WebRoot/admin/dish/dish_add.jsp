...
<html>
	...
	<body>
		...
		<div class="addstu">
			<form action="/OrderSysSSH/dishAction-add" method="post" enctype="multipart/form-data">
				<p>
					<span>
						<span id="">菜品名称:</span>
				...
				<p>
					...
					<span style="margin: 0 100px;">
						...
						<select name="isRecommended">
							...
							<option value="是">推荐改菜品</option>
							<option value="否">不推荐改菜品</option>
						</select>
					</span>
				</p>
				<span id="">菜品详述:</span>
				<p style="margin:0px 0px 0px 90px;width:50%">
					<textarea name="txt" clos="10" rows="7" warp="physical" style="width:100%;resize:none;font-family: '微软雅黑';"></textarea>
				</p>
				<p class="img">
					<span>
						<span id="">菜品图鉴:</span>
					...
					<span>
						<img src="#" id="icon" style="width: 100px;height: 100px;margin: 10px 90px;"/>
					</span>
				</p>
